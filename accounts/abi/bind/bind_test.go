...
var bindTests = []struct {
	...
	// Test that contract interactions (deploy, transact and call) generate working code
	{
		...
		`
			...
			"github.com/ir4tech/webb-evm/accounts/abi/bind"
			"github.com/ir4tech/webb-evm/accounts/abi/bind/backends"
...
func golangBindings(t *testing.T, overload bool) {
	...
	pwd, _ := os.Getwd()
	replacer := exec.Command(gocmd, "mod", "edit", "-x", "-require", "github.com/ava-labs/webb-evm@v0.0.0", "-replace", "github.com/ava-labs/webb-evm="+filepath.Join(pwd, "..", "..", "..")) // Repo root
	replacer.Dir = pkg
