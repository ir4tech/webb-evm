...
go build -ldflags "-X github.com/ir4tech/webb-evm/plugin/evm.GitCommit=$subnet_evm_commit -X github.com/ir4tech/webb-evm/plugin/evm.Version=$subnet_evm_version $static_ld_flags" -o "$binary_path" "plugin/"*.go
